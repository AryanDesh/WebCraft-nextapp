...
export default async function Home() {
  ...
  return (
    <>
      ...
      <section className="flex justify-center items-center flex-col gap-4 md:!mt-80 mt-[-10px]">
        ...
        <div className="flex  justify-center gap-4 flex-wrap mt-6">
          {pricingCards.map((card) => (
            ...
            >
              ...
              <CardContent>
                <span className="text-4xl font-bold">(card.price)
                  {/* {card.unit_amount && card.unit_amount / 100} */}
                </span>
                <span className="text-muted-foreground">/m
