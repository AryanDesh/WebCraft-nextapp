...
import PluraCategory from '@/components/icons/webcraft-catagory'
...
export const pricingCards = [
    {
      title: 'Starter',
      description: 'Perfect for trying out WebCraft',
      price: 'Free',
      duration: '',
  ...
  export const addOnProducts : {title : string, id : string}[]= [
    { title: 'Priority Support', id: 'plan_PCx2xFImcAmemR' },
  ]
